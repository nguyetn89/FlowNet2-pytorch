# Notice
This is a tiny version of FlowNet2 that was modified and adapted for my works on anomaly detection. The original repository is at [NVIDIA/flownet2-pytorch](https://github.com/NVIDIA/flownet2-pytorch)
...
`FlowNet2` or `FlowNet2C*` architectures rely on custom layers `Resample2d` or `Correlation`. <br />
